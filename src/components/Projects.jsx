...
function Projects() {
  ...
  <figure > <img src={shop} alt="" className='w-76 h-64 mt-5 rounded  shadow-black shadow-xl cursor-pointer'/>
   ...
   <figure><img src={clock} alt="" className='w-76 h-64 mt-5 rounded shadow-black shadow-xl cursor-pointer'/>
   ...
   <figure><img src={orp} alt="" className='w-76 h-64 mt-5 rounded shadow-black shadow-xl cursor-pointer'/>
   ...
   <figure><img src={todo} alt="" className='w-76 h-64 mt-5 rounded shadow-black shadow-xl cursor-pointer'/>
   <figcaption className='text-white font-bold text-lg'><a href="https://gorgeous-taffy-baafa2.netlify.app/" className="text-white">
