...
import PDF from './Tusharkumar04.pdf'


function About() {
 return (
 
    <div id="About" className='h-screen w-full pt-20 md:grid-col-2 grid justify-center grid-row-3 md:w-screen md:bg-indigo-200  bg-gradient-to-b from-sky-100 to-indigo-100'>
    ...
    responsive websites in the recruiting industry.  Highly motivated FrontEnd Developer seeking opportunities to grow and make a positive impact in a forward-thinking software development team. 
    </p>
    ...
    <img src={me} alt="" className=' h-72  rounded shadow-black shadow-xl cursor-pointers '/>
    </div>
    </div>
